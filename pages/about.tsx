      ...
      <section className="w-11/12 px-4 md:px-0 pt-24 md:pt-28 lg:pt-32 mx-auto md:w-3/4 lg:w-10/12  transition  dark:text-gray-300">
        <div className="divide-y divide-gray-800">
          <div className=" space-y-2 md:space-y-5">
            <h1 className="pb-3 lg:pb-1 lg:mb-5 text-3xl font-extrabold leading-9 tracking-tight  transition  dark:text-gray-100 sm:text-4xl sm:leading-10 md:text-5xl md:leading-14">
              About Me
            </h1>
          </div>
          <div className="items-start space-y-2 lg:grid lg:grid-cols-3 lg:space-y-0 lg:pt-4">
            <div className="flex flex-col items-center pt-6 xl:pt-5">
              ...
              <h3 className="pt-4 text-2xl text-gray-900  transition  dark:text-gray-200 md:text-3xl font-bold leading-8 tracking-tight">
                Pranav Birajdar
              </h3>
              <div className="md:text-lg text-gray-800  transition  dark:text-gray-400 mb-2 md:mt-1">
                Software Developer
              </div>
              <Icons />
            </div>
