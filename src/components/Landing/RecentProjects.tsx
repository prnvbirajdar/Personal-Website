  ...
  return (
    <section>
      <div className="text-left mt-16">
        <h2 className="text-3xl md:text-4xl font-bold mb-5  transition dark:text-white text-black">Recent Projects</h2>
      </div>
      <div className="mb-5 flex flex-col border border-gray-400 hover:border-gray-600  dark:border-gray-600 dark:hover:border-gray-400 transition rounded-lg md:mt-5">
        ...
        >
          <div>
            <h3 className="mb-2 text-xl font-semibold tracking-normal transition dark:text-gray-100 ">
              Lift Workout App
            </h3>
            <p className="text-sm md:text-base font-normal text-gray-900  transition dark:text-gray-300">
              Lift is a resistance training app that allows users to create, track, and update their daily workout
              routines.
            </p>
            <ul className="flex md:justify-end text-xs md:text-sm mt-3 transition font-semibold">
