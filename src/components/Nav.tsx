...
const Nav2 = () => {
  ...
  return (
    <header className="fixed top-0 w-full dark:text-gray-100 text-black bg-gray-50 dark:bg-black z-20">
            ...
            <div className="flex items-center justify-between w-full">
                ...
                <Link href="/">
                  <a aria-label="Logo">
                    <svg
                      ...
                      className="h-8 w-8 dark:hover:text-gray-300 transition dark:focus:text-gray-300 "
                    >
              ...
              <div className=" hidden md:block">
                <div className="ml-10 flex items-baseline space-x-4">
                  <Link href="/">
                    <a className=" hover:bg-gray-200 focus:bg-gray-200 dark:hover:bg-gray-900 transition dark:focus:bg-gray-900 px-3 py-2 rounded-md text-sm lg:text-base font-medium">
                      Home
                    </a>
                  </Link>
                  <Link href="/blog">
            ...
            <div className="border-b dark:border-gray-600 md:hidden" id="mobile-menu">
              <div ref={ref} className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                <div onClick={() => setIsOpen(!isOpen)} aria-hidden="true">
                  <Link href="/">
                    <a className="hover:bg-gray-200 focus:bg-gray-200 dark:hover:bg-gray-900 transition dark:focus:bg-gray-900 block px-3 py-2 rounded-md text-sm md:text-base font-medium">
                      Home
                    </a>
                  </Link>
                </div>
