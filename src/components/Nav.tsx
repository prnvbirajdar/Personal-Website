...
const Nav2 = () => {
  ...
  return (
    <header className="fixed top-0 w-full transition bg-white dark:text-gray-100 text-black  dark:bg-black z-20">
      <nav className="border-b transition border-gray-200 dark:border-gray-800">
            ...
            <div className="flex items-center">
                ...
                <Link href="/">
                  <a aria-label="Logo">
                    <svg
                      ...
                      className="h-8 w-8  hover:text-indigo-700 focus:text-indigo-700 dark:hover:text-indigo-500 transition dark:focus:text-indigo-500 "
                    >
              ...
              <div className=" hidden md:block">
                <div className="ml-10 flex items-baseline space-x-4">
                  <Link href="/">
                    <a className=" hover:bg-gray-100 focus:bg-gray-100 dark:hover:bg-gray-900 transition dark:focus:bg-gray-900 px-3 py-2 rounded-md text-sm lg:text-base font-medium">
                      Home
                    </a>
                  </Link>
                  <Link href="/blog">
            ...
            <div className="border-b dark:border-gray-600 md:hidden" id="mobile-menu">
              <div ref={ref} className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                <div onClick={() => setIsOpen(!isOpen)} aria-hidden="true">
                  <Link href="/">
                    <a className=" hover:bg-gray-100 focus:bg-gray-100 dark:hover:bg-gray-900 transition dark:focus:bg-gray-900 block px-3 py-2 rounded-md text-sm md:text-base font-medium">
                      Home
                    </a>
                  </Link>
                </div>
