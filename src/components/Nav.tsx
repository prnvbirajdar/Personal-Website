            ...
            <div className="flex items-center">
                ...
                <Link href="/">
                  <a>
                    <svg
                      ...
                      className="h-8 w-8 text-gray-100 hover:text-gray-300 transition focus:text-gray-300 "
                    >
              ...
              <div className=" hidden md:block">
                <div className="ml-10 flex items-baseline space-x-4">
                  <Link href="/">
                    <a className=" hover:bg-gray-900 transition focus:bg-gray-900 px-3 py-2 rounded-md text-sm font-medium">
                      Home
                    </a>
                  </Link>
                  <Link href="/blog">
            ...
            <div className="border-b border-gray-600 md:hidden" id="mobile-menu">
              <div ref={ref} className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                <div onClick={() => setIsOpen(!isOpen)} aria-hidden="true">
                  <Link href="/">
                    <a className="hover:bg-gray-900 transition focus:bg-gray-900 block px-3 py-2 rounded-md text-base font-medium">
                      Home
                    </a>
                  </Link>
                </div>
