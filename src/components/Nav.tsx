...
const Nav2 = () => {
  ...
  return (
    <header className="fixed top-0 w-full transition duration-500 bg-white dark:text-gray-100 text-black  dark:bg-black z-20">
      <nav className="border-b transition duration-500 border-gray-200 dark:border-gray-800">
        <div className=" max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className=" flex items-center justify-between h-16">
            <div className="flex items-center">
                ...
                <Link href="/">
                  <a aria-label="Logo">
                    <svg
                      ...
                      className="h-8 w-8  duration-500 hover:text-gray-600 focus:text-gray-600 dark:hover:text-gray-300 transition dark:focus:text-gray-300 "
                    >
              ...
              <div className=" hidden md:block">
                <div className="ml-10 flex items-baseline space-x-4">
                  <Link href="/">
                    <a className=" duration-500 hover:bg-gray-100 focus:bg-gray-100 dark:hover:bg-gray-900 transition dark:focus:bg-gray-900 px-3 py-2 rounded-md text-sm lg:text-base font-medium">
                      Home
                    </a>
                  </Link>
                  <Link href="/blog">
            ...
            <button
              ...
              onClick={toggleMode}
              className=" hidden md:block self-center bg-white duration-500 hover:bg-gray-100 focus:ring focus:ring-gray-500 transition dark:bg-black dark:hover:bg-gray-900 focus:outline-none rounded-md p-1.5"
            >
            ...
            <div className="-mr-2 flex md:hidden space-x-4">
              ...
              <button
                ...
                aria-label="dark mode"
                onClick={toggleMode}
                className=" block md:hidden self-center bg-white duration-500 hover:bg-gray-100 focus:ring focus:ring-gray-500 transition dark:bg-black dark:hover:bg-gray-900 focus:outline-none rounded-md p-1.5"
              >
                {mode === 'dark' ? <Sun aria-hidden="true" /> : <Moon aria-hidden="true" />}
              </button>
              <button
            ...
            <div className="border-b dark:border-gray-600 md:hidden" id="mobile-menu">
              <div ref={ref} className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                <div onClick={() => setIsOpen(!isOpen)} aria-hidden="true">
                  <Link href="/">
                    <a className="duration-500 hover:bg-gray-100 focus:bg-gray-100 dark:hover:bg-gray-900 transition dark:focus:bg-gray-900 block px-3 py-2 rounded-md text-sm md:text-base font-medium">
                      Home
                    </a>
                  </Link>
                </div>
