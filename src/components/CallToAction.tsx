  ...
  return (
    <div className="w-11/12 px-4 py-20 mx-auto text-center md:w-3/4 lg:w-2/4  ">
      ...
      {/* <div className="mb-0 space-x-0 md:space-x-2">
        <a
          href="mailto:prnvbirajdar@gmail.com"
          className="bg-gray-200  hover:bg-gray-300 text-sm font-bold lg:text-base tracking-normal my-5 md:my-7 p-2.5 px-4 md:px-5 rounded ring-2 ring-gray-400 ring-opacity-50 dark:bg-gray-900 dark:bg-opacity-25 dark:hover:bg-opacity-100 dark:focus:bg-opacity-100 shadow 
        >
          Say Hello!
        </a>
      </div> */}
