    ...
    <section className="hidden lg:flex w-full ">
      ...
      <div className="w-2/5 z-10  py-3  my-auto rounded-lg lg:-ml-12 xl:-ml-24  ">
        ...
        <div className=" w-full  ">
          <p className="text-right leading-snug  bg-gray-100 dark:bg-gray-900 p-4 rounded-lg">{project.description}</p>
  ...
  return (
    <section className="hidden lg:flex w-full ">
      <div className="w-2/5 z-10  py-3  my-auto rounded-lg lg:ml-6 xl:ml-12  ">
        ...
        <div className=" w-full   ">
          <p className="  leading-snug  bg-gray-100 dark:bg-gray-900 p-4 rounded-lg">{project.description}</p>
